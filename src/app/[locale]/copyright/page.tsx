...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Copyright Notice - World Fighters Wiki',
    description: 'Copyright and intellectual property information for World Fighters Wiki. Learn about content ownership, fair use, DMCA policy, and how to report copyright infringement.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: 'Copyright Notice - World Fighters Wiki',
      description: 'Copyright and intellectual property information for World Fighters Wiki.',
      images: [
        {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              © 2025-2026 World Fighters Wiki. All rights reserved.
            </p>
            <p>
              Unless otherwise noted, all original content on this website, including but not limited to text,
              graphics, logos, guides, articles, and compilations, is the property of World Fighters Wiki and is
              protected by international copyright laws.
            </p>

            <h3>1.2 Game Assets and Trademarks</h3>
            <p>
              World Fighters Wiki is an <strong>unofficial fan-made website</strong> and is NOT affiliated with,
              endorsed by, or associated with:
            </p>
            <ul>
              <li><strong>Roblox Corporation</strong> - Owner of the Roblox platform</li>
              <li><strong>StarX Inc</strong> - Published developer group for World Fighters on Roblox</li>
            </ul>
            <p>
            ...
            <ul>
              ...
              <li><strong>World Fighters</strong> - Trademark of StarX Inc and/or the game developers</li>
              <li><strong>World Fighters Wiki</strong> - Our own branding (not affiliated with the game)</li>
            </ul>
            <p>
              ...
              affiliation with World Fighters Wiki.
            </p>
            ...
            <p>
              ...
              World Fighters Wiki<br />
              Email: <a href="mailto:dmca@worldfighters.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@worldfighters.wiki</a>
            </p>
            <p>
            ...
            <ul>
              <li>Provide clear attribution to "World Fighters Wiki"</li>
              <li>Include a link back to the original page (if digital)</li>
              <li>Do not imply endorsement or affiliation</li>
            </ul>
            <p>
              Example attribution: <em>"Source: World Fighters Wiki (worldfighters.wiki)"</em>
            </p>
            ...
            <p>
              <strong>General Inquiries:</strong> <a href="mailto:copyright@worldfighters.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">copyright@worldfighters.wiki</a><br />
              <strong>DMCA Notices:</strong> <a href="mailto:dmca@worldfighters.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@worldfighters.wiki</a>
            </p>
            <p>
