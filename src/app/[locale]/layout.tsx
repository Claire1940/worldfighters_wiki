...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
	...
	const title = 'World Fighters Wiki - Codes, Units & Beginner Guide'
	const description = 'World Fighters Wiki helps Roblox players find new codes, unit lists, beginner tips, boss locations, worlds, passives, raids, and update notes in one place.'
			...
			images: [
				{
					...
					width: 1920,
					height: 1080,
					alt: 'World Fighters Wiki - Roblox Fighting Simulator',
				},
			],
		},
		twitter: {
