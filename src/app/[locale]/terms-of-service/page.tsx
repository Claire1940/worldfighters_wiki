...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: "Terms of Service - World Fighters Wiki",
    description: "Read the Terms of Service for World Fighters Wiki. Learn about user responsibilities, content usage guidelines, and legal terms for using our Roblox game resource platform.",
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      siteName: "World Fighters Wiki",
      title: "Terms of Service - World Fighters Wiki",
      description: "Terms and conditions for using World Fighters Wiki.",
      images: [
        {
          url: `${siteUrl}/images/hero.webp`,
          width: 1200,
          height: 630,
          alt: "World Fighters Wiki",
        },
      ],
    },
    twitter: {
      ...
      <section className="relative py-20 px-4 border-b border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 text-lg mb-2">
            Terms and conditions for using World Fighters Wiki
          </p>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              By accessing and using World Fighters Wiki ("the Website", "we", "our", or "us"), you agree to be bound
              by these Terms of Service ("Terms"). If you do not agree to these Terms, please do not use our Website.
            </p>
            <p>
              These Terms constitute a legally binding agreement between you ("User", "you", or "your") and World Fighters Wiki.
              Your continued use of the Website signifies your acceptance of these Terms and any future modifications.
            </p>

            <h2>2. Description of Service</h2>
            <p>
              World Fighters Wiki is an unofficial, community-driven fan website that provides information, guides, tools,
              and resources related to the Roblox game "World Fighters". Our services include, but are not limited to:
            </p>
            <ul>
              <li>Game guides and beginner progression strategies</li>
              <li>Codes, reward notes, and redemption guidance</li>
              <li>Fighter, passive, world, and boss information</li>
              <li>Raid, trial, event, and update resources</li>
              <li>Community discussion and content</li>
            </ul>
            <p>
              <strong>Important:</strong> World Fighters Wiki is NOT affiliated with, endorsed by, or associated with
              Roblox Corporation, StarX Inc, or the official developers of World Fighters. We are an independent fan community.
            </p>
            ...
            <p>
              ...
              graphics, logos, images, and software) are owned by World Fighters Wiki and are protected by international
            ...
            <p>
              ...
              trademarks, are the property of Roblox Corporation, StarX Inc, and/or the developers of World Fighters. We use such
            ...
            <ul>
              ...
              <li><strong>Game Availability:</strong> Roblox game availability and game updates may change without notice. We are not responsible for platform access or game changes.</li>
            </ul>
            <p>
            ...
            <p>
              TO THE FULLEST EXTENT PERMITTED BY LAW, WORLD FIGHTERS WIKI SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL,
            ...
            <p>
              ...
              you and World Fighters Wiki regarding the use of the Website and supersede any prior agreements or understandings.
            </p>
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:legal@worldfighters.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">legal@worldfighters.wiki</a>
            </p>
            <p>
